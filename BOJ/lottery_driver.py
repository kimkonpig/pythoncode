...
def main(winning_numbers, tries, total_prize, total_cost):
    out_file = open('nackseozzang.html', 'w', encoding='utf-8')
...
WINNING_NUMBERS = nackseozzang.draw_winning_numbers()
NUM_TRIES = 100
...
for i in range(NUM_TRIES):
    attempt = sorted(nackseozzang.generate_numbers(6))
    prize = nackseozzang.check(attempt, WINNING_NUMBERS)
